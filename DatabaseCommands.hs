...
intersect                       :: ([Char] -> IO ()) -> [Char] -> Map String (Map [Char] Field) -> IO ()
...
printFields                       :: ([Char] -> IO ()) -> [Char] -> Map String (Map [Char] Field) -> IO ()
...
printFieldInfo                       :: ([Char] -> IO ()) -> [Char] -> Map String (Map [Char] Field) -> IO ()
...
findField                       :: ([Char] -> IO ()) -> [Char] -> Map String (Map [Char] Field) -> IO ()
...
commandList                    :: ([Char] -> IO ()) -> [Char] -> Map [Char] (Map String (Map [Char] Field) -> IO ())
